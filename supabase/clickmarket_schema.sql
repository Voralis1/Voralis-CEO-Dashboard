...
--                       (2026-07) — mapping confirmé sur données réelles (audit en direct) :
...
--                       vente). annulees = shipping_status='cancelled' (plus l'OR avec
--                       confirmation_status d'avant). retournees = shipping_status='return',
--                       une valeur réelle qui existe (audité), remplace l'ancien "non exposé".
